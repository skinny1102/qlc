  ...
  <div class="m-4" style="width: 500px;">
    ...
    <div class=" row justify-content-center">
      <div class="col-12" style="margin-left: 80px;">
        <p class="text-center header-receipt mb-0" style="font-size: 30px;">Báo Cáo Thống Bán Hàng</p>
        <p class="text-center">Ngày : <?php echo date('Y-m-d', strtotime($dateTo)); ?>   đến  <?php echo date('Y-m-d', strtotime($dateTo)); ?></p>
